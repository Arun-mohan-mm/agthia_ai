...
class Restaurants(models.Model):
    ...
    instagram_link = models.URLField(max_length=200, default="https://www.instagram.com/")
    facebook_link = models.URLField(max_length=200, default="https://www.facebook.com/")
    twitter_link = models.URLField(max_length=200, default="https://www.twitter.com/")
