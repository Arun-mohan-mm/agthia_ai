...
def home(request):
    ...
    return render(request,'tem/home_page2.html',{'lockk':lockk,'interk':interk,'abb':abb,'o_p':o_p})
...
def admin_home(request):
    return render(request,'tem/admin_home.html')
...
def careers_adm(request):
    if request.method == 'POST':
        ...
        return redirect('admin_home')
    return render(request, 'tem/careers_adm.html')
...
def view_vacancy_adm(request):
    ...
    return render(request,'tem/view_vacancy_adm.html',{'hyh':hyh})
...
def edit_vacancy_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        return redirect('view_vacancy_adm')
    return render(request, 'tem/edit_vacancy_adm.html', {'gh': gnk})
...
def view_job_apls(request):
    ...
    return render(request, 'tem/view_job_apls.html', {'rkt': rkt})
...
def search_job_apls(request):
    ...
    return render(request, 'tem/view_job_apls.html', {'rkt': results})
...
def mnge_restaurants_adm(request):
    ...
    return render(request, 'tem/mnge_restaurants_adm1.html',{'hth':hth})
...
def descr_restau_adm(request, id):
    ...
    return render(request, 'tem/descr_restau_adm.html', {'hth': hth})
...
def images_restau_adm(request, id):
    ...
    return render(request, 'tem/images_restau_adm.html', {'hyh': hyh})
...
def edit_img_resta_adm(request, id):
    ...
    return render(request, 'tem/edit_img_resta_adm.html', {'hyh': hyh})
...
def add_img_resta_adm(request):
    ...
    if request.method == 'POST':
        ...
        redd = "/images_restau_adm/" + str(resta_id)
        return redirect(redd)
    return render(request,'tem/add_img_resta_adm.html')
...
def edit_resta_adm(request, id):
    ...
    return render(request,'tem/edit_resta_adm.html',{'dvd':dvd})
...
def add_resta_adm(request):
    if request.method == 'POST':
        ...
        return redirect('mnge_restaurants_adm')
    return render(request, 'tem/add_resta_adm.html')
...
def search_resta(request):
    ...
    return render(request,'tem/mnge_restaurants_adm1.html',{'hth':results})
...
def view_subscr_adm(request):
    ...
    return render(request, 'tem/view_subscr_adm.html', {'hyh':hyh})
...
def about_adm(request):
    ...
    return render(request, 'tem/about_adm.html',{'hth':hth})
...
def add_about_adm(request):
    ...
    return render(request, 'tem/add_about_adm.html')
...
def edit_about_adm(request, id):
    ...
    return render(request, 'tem/edit_about_adm.html', {'dvd': dvd})
...
def our_ple_adm(request):
    ...
    return render(request, 'tem/our_ple_adm.html',{'hth':hth})
...
def add_our_ple_adm(request):
    ...
    return render(request, 'tem/add_our_ple_adm.html')
...
def edit_our_ple_adm(request, id):
    ...
    return render(request, 'tem/edit_our_ple_adm.html', {'dvd': dvd})
...
def mission_adm(request):
    ...
    return render(request, 'tem/mission_adm.html',{'hth':hth})
...
def add_mission_adm(request):
    ...
    return render(request, 'tem/add_mission_adm.html')
...
def edit_mission_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        dvd.save()
        return redirect('mission_adm')
    return render(request, 'tem/edit_mission_adm.html', {'dvd': dvd})
...
def vision_adm(request):
    ...
    return render(request, 'tem/vision_adm.html',{'hth':hth})
...
def add_vision_adm(request):
    ...
    return render(request, 'tem/add_vision_adm.html')
...
def edit_vision_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        dvd.save()
        return redirect('vision_adm')
    return render(request, 'tem/edit_vision_adm.html', {'dvd': dvd})
...
def word_ceo_adm(request):
    ...
    return render(request, 'tem/word_ceo_adm.html',{'hth':hth})
...
def add_word_ceo_adm(request):
    ...
    return render(request, 'tem/add_word_ceo_adm.html')
...
def edit_word_ceo_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        dvd.save()
        return redirect('word_ceo_adm')
    return render(request, 'tem/edit_word_ceo_adm.html', {'dvd': dvd})
...
def news_adm(request):
    ...
    return render(request, 'tem/news_adm.html',{'hth':hth})
...
def add_media_adm(request):
    ...
    return render(request, 'tem/add_media_adm.html')
...
def edit_media_adm(request, id):
    ...
    if request.method == 'POST':
        ...
        dvd.save()
        return redirect('news_adm')
    return render(request, 'tem/edit_media_adm.html', {'dvd': dvd})
